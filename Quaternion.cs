...
public partial struct Quaternion : IEquatable<Quaternion>
{
    ...
    private static Quaternion Internal_FromEulerRad(Vector3 euler) {throw new Exception("Internal_FromEulerRad not implemented");}

    private static Vector3 Internal_ToEulerRad(Quaternion rotation) {
        throw new Exception("Internal_ToEulerRad not implemented");
    }
    ...
    public static Quaternion LookRotation(Vector3 forward) { 
        throw new Exception("LookRotation not implemented");
        // return LookRotation(forward, Vector3.up);
    }

    public static Quaternion LookRotation(Vector3 forward, Vector3 upwards) {
        throw new Exception("LookRotation(arg1, arg2) not implemented");
    }

    private static void Internal_ToAxisAngleRad(Quaternion q, out Vector3 axis, out float angle) {
        throw new Exception("Internal_ToAxisAngleRad not implemented");
    }

    public static Quaternion FromToRotation(Vector3 fromDirection, Vector3 toDirection) {
        throw new Exception("FromToRotation not implemented");
    }

    public static Quaternion SlerpUnclamped(Quaternion a, Quaternion b, float t) {
        throw new Exception("SlerpUnclamped not implemented");
    }
